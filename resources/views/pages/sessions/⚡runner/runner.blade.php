<div class="mx-auto flex w-full max-w-7xl flex-col gap-4" x-data="{ dmNotesOpen: false }">
    ...
    <div class="grid gap-4 lg:grid-cols-3">
        ...
        <div class="flex flex-col gap-4 self-stretch">
            ...
            {{-- Session Notes --}}
            <div class="flex flex-1 flex-col rounded-xl border border-zinc-200 bg-white p-4 dark:border-zinc-700 dark:bg-zinc-800">
                ...
                @else
                    <div class="min-h-0 flex-1 space-y-1 overflow-y-auto">
                        @foreach ($logs as $log)
                            <div class="group rounded px-2 py-1.5 text-sm">
                                <div class="flex items-center gap-2">
                                ...
                                <div class="mt-0.5 flex flex-wrap items-baseline gap-x-2 pl-10">
                                    <p class="text-xs text-zinc-600 dark:text-zinc-400">{{ \Illuminate\Support\Str::words($log->entry, 10) }}</p>
                                    @if ($log->scene_id)
        ...
        <div class="space-y-4">
            ...
            @if ($currentScene)
                <div class="flex items-center gap-1.5 text-sm text-zinc-500 dark:text-zinc-400">
                    ...
                    <span>{{ __('Scene') }}: <strong class="text-zinc-700 dark:text-zinc-300">{{ $currentScene->title }}</strong></span>
                </div>
            @endif
